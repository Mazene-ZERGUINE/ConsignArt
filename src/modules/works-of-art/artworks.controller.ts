...
export class ArtworksController {
  ...
  @ApiOperation({
    description:
      'Endpoint used to list art works scoped to the caller (admin: all, gallery/artist: own, collector: available catalog), optionally filtered by ?status=',
  })
  public async findAll(
    ...
    return this.getArtWork.list(requester, status);
  }
